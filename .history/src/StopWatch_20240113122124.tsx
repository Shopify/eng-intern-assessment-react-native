...
const styles = StyleSheet.create({
  ...
  container: {
    minWidth: 250, // Adjust this based on the expected longest time string
    alignItems: 'flex-start', // Keeps the text stable
    justifyContent: 'center',
  },
  timerText: {
    fontSize: 24,
    ...
    textAlign: 'center', // Align text to the left to keep it stable
  },
  lapText: {
    fontSize: 16,
  },
