...
const styles = StyleSheet.create({
  ...
  timerContainer: {
    minWidth: 250, // Adjust this width based on the expected longest time string
    alignItems: 'flex-center', // Align items to the start (left)
    justifyContent: 'center',
    paddingHorizontal: 10, // Add some padding for aesthetics
  },
  timerText: {
    fontSize: 24,
    fontWeight: 'bold',
    // fontFamily: 'monospace', // Monospace font for equal character width
