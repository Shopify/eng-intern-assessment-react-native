...
const StopWatch = () => {
  ...
  const formatTimeUnit = (unit: number) => {
    ...
    return isHour ? unitStr.padStart(3, '0') : unitStr.padStart(2, '0');
  };
  ...
  const formatTime = (milliseconds: number) => {
    ...
    return `${formatTimeUnit(hours, true)}:${formatTimeUnit(minutes)}:${formatTimeUnit(seconds)}:${formatTimeUnit(millis)}`;
  };
