...
const formatTimeSegment = (segmentValue: number, padLength: number): string => {
  return segmentValue.toString().padStart(padLength, '0');
};
...
const styles = StyleSheet.create({
  ...
  container: {
    ...
    alignItems: 'center', // This will center the text horizontally within the container.
