...
const styles = StyleSheet.create({
  ...
  buttonContainer: {
    ...
    marginTop: 10, // You can adjust this value as needed
  },
  lapsContainer: {
    // marginTop: 20, // Adjust the margin as needed
    width: '100%', // Use the full width of the screen for the laps container
    alignItems: 'center', // Center-align the lap text
    top: 100, // Adjust this value based on the height of the button container plus any desired margin
    position: 'absolute',
    top: '50%', // Adjust this value so that it's below the button container
    alignItems: 'center',
  },
  },
});
