...
export const StateMapping: Record<
  StopButtonState,
  { btnLeft: StopButtonType; btnRight: StopButtonType }
> = {
  [StopButtonState.INITIAL]: {
    btnLeft: StopButtonType.EMPTY,
    btnRight: StopButtonType.START,
  },
  [StopButtonState.PLAYING]: {
    btnLeft: StopButtonType.LAP,
    btnRight: StopButtonType.STOP,
  },
  [StopButtonState.PAUSED]: {
    btnLeft: StopButtonType.RESET,
    btnRight: StopButtonType.START,
  },
};

const StopwatchButtonMapping: Record<
  StopButtonType,
  {
    text?: string;
...
const StopWatchButton = ({ type, buttonClick }: StopWatchButtonProps) => {
