  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttons}>
        <StopWatchButton name={isRunning ? 'Lap' : 'Reset'} color="gray" onPress={isRunning ? handleLap : handleReset} />
        <StopWatchButton name={isRunning ? 'Stop' : 'Start'} color={isRunning ? 'red' : 'green'} onPress={handleStartStop} />
      </View>
