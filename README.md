# Important Notes Upon Completion.

1. I redesigned the given testing suite so that it was more suited to my design but I retained most of the original functionality.
2. I choose a modular approach: App ties together the presentational components (StopWatchButton and StopWatch). See further comments in each file.
